...
button_text = 'MARK THE START POINT'
...
# def desText(s, x=170, y=50):
#     pygame.draw.rect(screen, WHITE, (5, 10, 250, 40))
#     font = pygame.font.SysFont('segoeuisemilight', 16)
